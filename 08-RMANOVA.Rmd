...
The critical value for the repeated measures version is slightly higher. This is because when df2 (the denominator) is smaller, the f-distribution spreads out to the right a little bit. When it is skewed like this, we get some bigger Fs a greater proportion of the time.
...
Prior research shown that people type words way faster than than random letters, but if you made the random letters a little bit more English-like, then people type those English kinds of letter a little bit faster, but not as fast as random letters. 
