...
Hello everyone, this is Matt Crump, what you are reading right now is an addition to the original textbook, a short new beginning. I'm a cognitive psychologist who uses and teaches statistics, and I'm still very much a student. The more I learn about statistics and psychology, the more I realize that I have so much more to learn. I am in the process of adding some very important pieces about statistics and psychology into the second version of this book. I vaguely knew about these pieces before, and I failed to grasp how necessary it is to discuss them. What am I talking about? Briefly, I am talking about the need to understand our modern statistics practices in psychology within a historical and socio-cultural context. This is necessary because there is a common dark side to the beginnings of statistics and psychology. That side is eugenics.

<div class="marginnote">
Eugenics is a large subject matter, and it is impossible to give that subject a full treatment here. This textbook has appendix on eugenics containing a list of resources and readings for learning more about eugenics.
</div>

Let me draw your attention to the quote from Sir Ronald Fisher above. Fisher is a notable statistician because he developed several statistical tests that are still widely used today. You will learn about some of these test throughout this book. Fisher is also notable because of his views on eugenics. Before we meet Fisher in this textbook we will meet Karl Pearson, another famous statistician. Pearson was also a eugenicist. In fact, Pearson was the first director of the Galton Laboratory for National Eugenics (1907) at University College London in Britain. Pearson was the protege of another famous statistician, Sir Francis Galton. Galton coined the term eugenics, and is generally acknowledged as the "father" of the eugenics movement. When we look at the beginnings of psychology in America, we learn that between 1892 and 1947, there were 31 presidents of the American Psychological Association that were also leaders in eugenics movements and societies. The entanglement of eugenics, statistics, psychology, science, and society is a very deep one, and many books have been written and will be written on the topic. In many ways, any kind of proper treatment of the subject is well beyond the scope of this book. Nevertheless, these issues can not be ignored, and I'll try my best to discuss them throughout.

So, before we move on, why does it matter that early statisticians and psychologists were also eugenicists? It matters because many human atrocities have been and in some cases still are being committed in the name of eugenics. And, some of these atrocities are directly the fault of statisticians and psychologists. If you are unfamiliar with the eugenics movement, the basic idea is that the "human race" can be improved over generations by breeding people, like plants or animals. Positive eugenics is about how encourage "good" people to breed with each other. Negative eugenics is about how to eliminate "bad" people from breeding. Eugenic ideas have permeated society throughout the world in many different ways, and they have led to atrocities such as legalized forced sterilizations of vulnerable populations, to the Nazi genocide. After world war II, the word eugenics became unpopular because of the horrors of the German eugenic program. Nevertheless, the ideas did not go away. 

In this textbook we will be learning about statistical tools that psychologists use for research. In many cases, these tools were created by eugencists to be used in the service of eugenics. At the same time, the statistics tools are very general mathematical ideas that can be applied to very wide range of problems. So, even though the tools are certainly tainted because of who made them ande how they were used, I believe it is certainly possible to conduct statistics in psychology without being a eugenicist. In fact, I think it is important that psychologists recognize this history, work towards apologizing and repairing the damage caused by it, and reflect on their own practices to remove any residual eugenic influences they may be unaware of.
