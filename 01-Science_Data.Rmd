...
We could also use **predictors** and **outcomes**. The idea here is that what you’re trying to do is use $X$ (the predictors) to make guesses about $Y$ (the outcomes). This is summarised in the table:
